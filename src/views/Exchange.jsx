...
const Exchange = () => {
  ...
  useEffect(() => {
     ...
     const getBSCElxbalance = async () => {
      try {
        ...
        // console.log("bnbFees" , bnbFees.data);
     ...
     const getEthExBalance = async () => {
      ...
      // console.log("ethFees" , ethFees.data);
      } catch (error) {
        alertService.showError(error.message);
      }
    };
  ...
  const switchElxAmount = async (_formInput ,{resetForm}) => {
    try {
      ...
      let admin_wallet_address=walletAddress.data;
      ...
      if(exchangeType==="BnbToEth"){
        ...
        let checkAllowance = await userService.bridgeBSCAllowance(walletAddress.data);
        ...
        // console.log('bscElxBridgeBalance',bscElxBridgeBalance,_formInput._exchangeAmt);
        ...
        let checkAllowance = await userService.bridgeEthAllowance(walletAddress.data);
        if (checkAllowance.status === 'success') {
          const _nonce = current.getTime();
  ...
  return (
    <div className="">
      ...
      <div className="mb-6">
                    ...
                    <div className="grid lg:grid-cols-2 grid-cols-1 gap-4 px-20">
