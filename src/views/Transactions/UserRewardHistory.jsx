            ...
            // setTimeout(()=>{
              ...
              const getRecords = async () => {
                ...
                try {
                  ...
                  let rec = await apiService.getUserRewardHistory(page ,  perPage, user.wallet_address, search);
      
                  setRewardDistHistoryList(rec.records)
                  setTotalCount(rec.pagination.totalCount)
